// Auto-generated Part 1 for Thermodynamics - Thermal equilibrium
module.exports = [
  {
    ...
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The Zeroth Law of Thermodynamics enables us to define the concept of temperature.\\nReason (R): If two bodies A and B are separately in thermal equilibrium with a third body C, then A and B are in thermal equilibrium with each other.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A cavity or hole inside a metal plate expands when the plate is heated.\\nReason (R): Thermal expansion is photographic; the distance between any two points in the material increases by the factor $(1 + \\alpha \\Delta T)$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The Celsius and Fahrenheit scales read the same numerical value at $-40^\\circ$.\\nReason (R): From the relation $\\frac{C}{5} = \\frac{F - 32}{9}$, setting $C = F = x$ gives $9x = 5x - 160 \\implies 4x = -160 \\implies x = -40$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Water contracts when heated from $0^\\circ\\text{C}$ to $4^\\circ\\text{C}$.\\nReason (R): Water exhibits anomalous expansion between $0^\\circ\\text{C}$ and $4^\\circ\\text{C}$, reaching its maximum density at $4^\\circ\\text{C}$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): In a clamped metallic rod whose ends are fixed rigidly, cooling produces tensile thermal stress.\\nReason (R): When cooled, the rod tends to contract, but the rigid supports exert an outward pulling force on the ends to maintain its original length.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The triple point of water is chosen as the standard fixed point in modern thermometry rather than the normal freezing or boiling point of water.\\nReason (R): The triple point of water occurs at a unique temperature and pressure ($273.16\\text{ K}$ and $611.65\\text{ Pa}$) and is independent of external atmospheric pressure variations.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): For an isotropic solid, the coefficients of linear ($\\alpha$), superficial ($\\beta$), and cubical ($\\gamma$) expansion are in the ratio $1 : 2 : 3$.\\nReason (R): For small changes in temperature, $(1 + \\alpha \\Delta T)^2 \\approx 1 + 2\\alpha \\Delta T$ and $(1 + \\alpha \\Delta T)^3 \\approx 1 + 3\\alpha \\Delta T$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): When ice at $0^\\circ\\text{C}$ is mixed with an equal mass of water at $80^\\circ\\text{C}$, the final temperature of the mixture is $0^\\circ\\text{C}$.\\nReason (R): The heat released by cooling water from $80^\\circ\\text{C}$ to $0^\\circ\\text{C}$ is $m \\times 1 \\times 80 = 80m\\text{ cal}$, which exactly equals the latent heat required to melt mass $m$ of ice ($m L_f = 80m\\text{ cal}$).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Thermal equilibrium implies that two systems have the same temperature, not necessarily the same internal energy.\\nReason (R): Internal energy is an extensive property depending on the mass and nature of the substance, whereas temperature is an intensive property that governs the direction of spontaneous heat flow.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): When a liquid is heated in a glass vessel, the apparent coefficient of expansion of the liquid is $\\gamma_{\\text{app}} = \\gamma_{\\text{real}} - \\gamma_{\\text{vessel}}$.\\nReason (R): As the temperature increases, the vessel expands simultaneously, increasing its internal capacity.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The specific heat capacity of a substance during a phase change (melting or boiling) is mathematically infinite.\\nReason (R): During a phase change, heat is absorbed or released without any change in temperature ($\\Delta T = 0$), and $s = \\frac{Q}{m \\Delta T}$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): In cold climates, lakes freeze from top to bottom, preserving aquatic life beneath the ice surface.\\nReason (R): Water has its maximum density at $4^\\circ\\text{C}$, so as the surface water cools below $4^\\circ\\text{C}$, it becomes lighter and remains on top until it freezes into an insulating ice layer.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A pendulum clock made with an invar rod keeps almost accurate time throughout the year.\\nReason (R): Invar has an extremely small coefficient of linear expansion ($\\alpha \\approx 10^{-6}\\text{ K}^{-1}$), minimizing seasonal changes in pendulum length.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Calorimeters are usually made of thin polished copper sheets.\\nReason (R): Copper has a low specific heat capacity and high thermal conductivity, ensuring quick temperature equalization with minimal heat absorption from the contents.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The temperature of a system cannot be lowered below absolute zero ($0\\text{ K}$).\\nReason (R): At absolute zero, the kinetic energy of particles reaches its minimum permissible quantum ground-state value, and no further thermal energy can be extracted.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A thick glass tumbler is more likely to crack than a thin glass tumbler when hot tea is poured into it.\\nReason (R): Glass is a poor conductor of heat, so unequal expansion between the inner and outer surfaces of thick glass generates large thermal stress.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The water equivalent of $100\\text{ g}$ of copper of specific heat $0.1\\text{ cal/g}\\cdot^\\circ\\text{C}$ is $10\\text{ g}$.\\nReason (R): Water equivalent $W$ is defined as $W = m \\times s$, which represents the mass of water that would absorb the same amount of heat for the same temperature change.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): When steam at $100^\\circ\\text{C}$ is passed into water at $0^\\circ\\text{C}$, steam produces much more severe burns than boiling water at $100^\\circ\\text{C}$.\\nReason (R): Each gram of steam at $100^\\circ\\text{C}$ carries an additional $540\\text{ calories}$ of latent heat of vaporization that is released upon condensing into liquid water.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): If a solid floats in a liquid, the fraction of the solid submerged increases when the temperature is raised, assuming $\\gamma_{\\text{liquid}} > \\gamma_{\\text{solid}}$.\\nReason (R): Fraction submerged is $\\frac{V_{\\text{sub}}}{V_0} = \\frac{\\rho_{\\text{solid}}}{\\rho_{\\text{liquid}}}$, and the density of liquid decreases faster than that of solid when $\\gamma_l > \\gamma_s$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Cooking takes longer at high altitudes on mountaintops unless a pressure cooker is used.\\nReason (R): Atmospheric pressure decreases with altitude, which lowers the boiling point of water below $100^\\circ\\text{C}$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A constant-volume gas thermometer is more sensitive and accurate than a mercury liquid-in-glass thermometer.\\nReason (R): Gases have much larger coefficients of thermal expansion than liquids and expand uniformly over a very wide temperature range.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): During thermal conduction, temperature gradient $\\frac{dT}{dx}$ is defined as the rate of change of temperature with distance along the heat flow path.\\nReason (R): In steady state without lateral heat loss, the temperature gradient along a uniform rod is constant.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Two metal spheres of same material and same radius, one hollow and the other solid, expand by the same amount when heated through the same temperature rise.\\nReason (R): Thermal expansion depends only on the outer dimensions and the coefficient of linear expansion of the material, not on the presence of interior cavities.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): If $10\\text{ g}$ of ice at $0^\\circ\\text{C}$ is mixed with $10\\text{ g}$ of steam at $100^\\circ\\text{C}$, the final equilibrium temperature of the mixture is $100^\\circ\\text{C}$.\\nReason (R): Condensation of $10\\text{ g}$ of steam releases $5400\\text{ cal}$, which is far greater than the heat required to melt $10\\text{ g}$ of ice and heat the resulting water to $100^\\circ\\text{C}$ ($1800\\text{ cal}$).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "subtopic": "Thermal equilibrium",
    "subTopic": "Thermal equilibrium",
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Heat and work are equivalent forms of energy transfer.\\nReason (R): Joule's mechanical equivalent of heat $J \\approx 4.186\\text{ J/cal}$ relates mechanical work done to thermal energy produced.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "correctAnswer": "$L_1 \\alpha_1 = L_2 \\alpha_2$",
    "correctOptionIndex": 0,
  ...
  },
  {
    ...
    "correctAnswer": "Water at $100^\\circ\\text{C}$ with some steam",
    "correctOptionIndex": 0,
