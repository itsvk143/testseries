module.exports = [
  {
    ...
    "subtopic": "Laws of thermodynamics (zeroth, first, second)",
    "class": "Class 11",
    "difficulty": "Hard",
    "examType": "JEE Mains",
    "marks": 4,
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The first law of thermodynamics is essentially a statement of the principle of conservation of energy applied to thermodynamic systems.\\nReason (R): The first law states that the net heat supplied to a system equals the increase in its internal energy plus the work done by the system ($Delta Q = Delta U + W$).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Internal energy $U$ of an ideal gas is a state function, whereas heat $Q$ and work $W$ are path functions.\\nReason (R): The change in internal energy depends only on the initial and final states, whereas the heat exchanged and work done depend on the specific path taken between those states.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): For any cyclic process, the net change in internal energy of a system is zero.\\nReason (R): Because internal energy is a state property, the cyclic integral $\\oint dU = 0$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A heat engine cannot have an efficiency of $100\\%$ even if there is no friction or mechanical loss.\\nReason (R): According to the Kelvin-Planck statement of the Second Law of Thermodynamics, it is impossible to construct a heat engine operating in a cycle that absorbs heat from a single reservoir and converts it completely into mechanical work.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Heat cannot spontaneously flow from a colder body to a hotter body without an external input of work.\\nReason (R): This is the Clausius statement of the Second Law of Thermodynamics.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The Kelvin-Planck statement and the Clausius statement of the Second Law of Thermodynamics are completely equivalent.\\nReason (R): Violation of the Kelvin-Planck statement leads directly to a violation of the Clausius statement, and vice versa.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The efficiency of a Carnot engine depends only on the temperatures of the hot source and the cold sink, and is independent of the working substance.\\nReason (R): For a Carnot cycle, the ratio of heat exchanged equals the ratio of absolute temperatures: $Q_C / Q_H = T_C / T_H$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): No heat engine operating between two given temperatures $T_H$ and $T_C$ can have an efficiency greater than a Carnot engine operating between the same temperatures.\\nReason (R): Carnot's theorem states that a reversible engine operating between two thermal reservoirs has the maximum possible efficiency.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): When ice melts at $0^\\circ\\text{C}$ into water at $0^\\circ\\text{C}$ at atmospheric pressure, the heat supplied goes into increasing internal energy and doing work against the atmosphere.\\nReason (R): During a phase change at constant temperature and pressure, the first law gives $\\Delta Q = \\Delta U + P\\Delta V$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
    ...
    "correctAnswer": "Both (A) and (R) are true and (R) is the correct explanation of (A)",
    "explanation": "Even though temperature is constant, latent heat is absorbed ($Delta Q > 0$), bonds are broken (increasing potential part of $Delta U$), and volume contracts slightly ($Delta V < 0$, so work is done on the ice). By $Delta Q = Delta U + PDelta V$, the first law is strictly satisfied.",
    "type": "ASSERTION_REASON",
    "subject": "Physics",
    "chapter": "Thermodynamics",
    "subtopic": "Laws of thermodynamics (zeroth, first, second)",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): For an ideal gas, the change in internal energy in any process is given by $\\Delta U = n C_v \\Delta T$.\\nReason (R): Internal energy of an ideal gas depends solely on its temperature, so $(\\partial U / \\partial V)_T = 0$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The molar heat capacity of an ideal gas at constant pressure $C_p$ is always greater than that at constant volume $C_v$.\\nReason (R): At constant pressure, part of the heat supplied is utilized in doing external work against the surroundings during expansion ($C_p = C_v + R$).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The coefficient of performance of a refrigerator can be greater than $1$.\\nReason (R): The coefficient of performance is defined as $\\beta = Q_C / W$, and the heat removed from the cold reservoir $Q_C$ can be larger than the mechanical work input $W$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): If the door of a working household refrigerator is kept open in a closed, thermally insulated room, the temperature of the room will eventually increase.\\nReason (R): The refrigerator expels heat into the room equal to the heat removed from the interior plus the electrical energy consumed by the compressor ($Q_H = Q_C + W$).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): In a free expansion of an ideal gas into an evacuated insulated container, the entropy of the universe increases.\\nReason (R): Free expansion is an irreversible process, and the entropy of the universe always increases in an irreversible process.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A Carnot engine operating between $T_H = 600\\text{ K}$ and $T_C = 300\\text{ K}$ has an efficiency of $50\\%$.\\nReason (R): The efficiency of a Carnot engine is $\\eta = 1 - \\frac{T_C}{T_H} = 1 - \\frac{300}{600} = 0.50 = 50\\%$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The change in entropy of an ideal gas in an isothermal reversible expansion is positive.\\nReason (R): During an isothermal reversible expansion, heat is absorbed by the gas from the reservoir, so $\\Delta S = \\int \\frac{dQ_{\\text{rev}}}{T} > 0$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): In an adiabatic reversible process, the entropy of the system remains constant.\\nReason (R): In a reversible adiabatic process, no heat enters or leaves the system ($dQ_{\\text{rev}} = 0$), so $dS = \\frac{dQ_{\\text{rev}}}{T} = 0$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The First Law of Thermodynamics indicates the direction in which a thermodynamic process can naturally occur.\\nReason (R): The First Law states that energy is conserved in all thermodynamic processes.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): It is impossible to achieve absolute zero temperature in a finite number of thermodynamic operations.\\nReason (R): This is a statement of the Third Law of Thermodynamics (Nernst Heat Theorem).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Mayer's relation $C_p - C_v = R$ is valid strictly for ideal gases.\\nReason (R): For real gases, intermolecular forces and potential energy changes cause $(\\partial U / \\partial V)_T \\neq 0$, modifying the difference between heat capacities.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): An electric heater submerged in a well-insulated container of water heats the water, but this process cannot be reversed completely without external effects.\\nReason (R): Conversion of electrical work into heat is a completely irreversible thermodynamic process.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): When heat $Q$ is supplied to an ideal monoatomic gas at constant pressure, the fraction of heat converted into internal energy is $3/5$.\\nReason (R): For a monoatomic gas, $C_v = \\frac{3}{2}R$ and $C_p = \\frac{5}{2}R$, so $\\frac{\\Delta U}{\\Delta Q} = \\frac{C_v}{C_p} = \\frac{3}{5}$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The coefficient of performance of a heat pump is always greater than that of a refrigerator operating between the same two temperatures by exactly $1$.\\nReason (R): For a heat pump $\\alpha = Q_H / W$ and for a refrigerator $\\beta = Q_C / W$. Since $Q_H = Q_C + W$, we have $\\alpha = \\beta + 1$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A perpetual motion machine of the first kind (PMM1) is a machine that violates the First Law of Thermodynamics.\\nReason (R): A PMM1 produces continuous mechanical work without consuming an equivalent amount of energy from any source.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A perpetual motion machine of the second kind (PMM2) violates the Second Law of Thermodynamics even though it satisfies the First Law.\\nReason (R): A PMM2 converts heat drawn from a single reservoir completely into mechanical work without any heat rejection to a cold reservoir.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
