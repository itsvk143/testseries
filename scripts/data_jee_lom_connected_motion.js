module.exports = [
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In an ideal Atwood machine with masses $m_1$ and $m_2$ ($m_1 > m_2$) connected by a light inextensible string over a light frictionless pulley, the tension in the string is strictly less than $m_1 g$.\n\nReason R: Because mass $m_1$ accelerates downwards, the net downward force on it is $m_1 g - T = m_1 a > 0$, which requires $T < m_1 g$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
    ...
    "subTopic": "Connected motion and pulley problems",
    "difficulty": "Medium",
    "marks": 4,
    "negativeMarks": 1
  },
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In an ideal Atwood machine, the acceleration of the system is independent of the individual masses and depends only on their ratio.\n\nReason R: The acceleration is given by $a = \\frac{m_1 - m_2}{m_1 + m_2} g = \\frac{(m_1/m_2) - 1}{(m_1/m_2) + 1} g$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: The force exerted by the axle on the frictionless light pulley of an Atwood machine is equal to $2T$, where $T$ is the string tension.\n\nReason R: Two vertical segments of the string pull downward on the pulley, each with tension $T$, and for a massless pulley in equilibrium $\\sum F_y = 0$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: If two unequal masses $m_1 > m_2$ in an Atwood machine are released from rest, the center of mass of the two-block system accelerates downwards.\n\nReason R: The heavier mass accelerates downwards with $a$ while the lighter mass accelerates upwards with the same acceleration $a$, so $a_{\\text{cm}} = \\left(\\frac{m_1 - m_2}{m_1 + m_2}\\right) a = \\left(\\frac{m_1 - m_2}{m_1 + m_2}\\right)^2 g > 0$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: If a monkey climbs up a light rope hanging over a frictionless pulley with an acceleration relative to the rope, a counterweight of equal mass on the other end also rises with the same acceleration.\n\nReason R: The tension in the continuous light string is identical on both sides of the ideal pulley at all instants.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In a movable pulley system where block $A$ is attached to the axle of a movable pulley and block $B$ is attached to the free end of the string, if block $B$ moves with acceleration $a_B$, then block $A$ moves with acceleration $a_A = a_B / 2$.\n\nReason R: The length of the string remains constant, leading to the kinematic constraint equation $2 x_A + x_B = L$, so $2 a_A + a_B = 0$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: A block of mass $m$ resting on a frictionless horizontal table is connected to a hanging mass $M$ via a light string passing over a pulley at the edge of the table. The acceleration of the system is less than $g$.\n\nReason R: The only accelerating force on the whole system is the gravitational pull $Mg$ on the hanging mass, but the total mass being accelerated is $(M + m)$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In the horizontal table-hanging mass system, the tension in the string is strictly less than $Mg$.\n\nReason R: The hanging mass accelerates downward, so $Mg - T = M a > 0$, requiring $T < Mg$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: When a bird sitting inside a wire cage hanging from a spring balance starts flying horizontally, the reading of the spring balance remains unchanged.\n\nReason R: The bird exerts a downward force on air equal to its weight while flying, which is transmitted through the open wire mesh to the outside room air.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: If an elevator accelerating upward at $a$ carries an Atwood machine, the acceleration of the masses relative to the elevator is $a' = \\frac{m_1 - m_2}{m_1 + m_2} (g + a)$.\n\nReason R: In the non-inertial reference frame of the elevator, an effective downward gravity $g_{\\text{eff}} = g + a$ acts on both masses.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: When a light string connecting two masses in an Atwood machine is suddenly cut while the masses are in motion, both masses immediately begin free fall under gravity.\n\nReason R: As soon as the string is cut, the tension drops to zero instantaneously, leaving only gravity as the net force on each mass.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In a system of three blocks $m_1, m_2, m_3$ placed in contact in a line on a frictionless horizontal plane, if a horizontal force $F$ is applied to $m_1$, the contact force between $m_2$ and $m_3$ is $\\frac{m_3}{m_1 + m_2 + m_3} F$.\n\nReason R: The contact force between $m_2$ and $m_3$ accelerates only the mass $m_3$ with the common acceleration $a = \\frac{F}{m_1 + m_2 + m_3}$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: If a light spring balance connects two masses of $5\\text{ kg}$ each suspended over a frictionless light pulley, the reading of the spring balance is $10\\text{ kgf}$.\n\nReason R: A spring balance measures the sum of the forces acting on both its ends.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In a wedge-block system where a block of mass $m$ slides down a frictionless inclined wedge of mass $M$ placed on a frictionless horizontal floor, the horizontal component of momentum of the system is conserved.\n\nReason R: No external force acts on the (wedge + block) system along the horizontal direction.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: The tension in a massive rope accelerating under an applied force varies uniformly along its length.\n\nReason R: Each cross-section of the rope must accelerate the remaining mass of the rope located ahead of or behind that section.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: For two blocks connected by a light string on a smooth horizontal surface pulled by force $F$ applied on block $A$, the tension in the string is independent of which block is pulled.\n\nReason R: The acceleration of the system $a = F/(m_A + m_B)$ is independent of which block is pulled.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In an Atwood machine, the tension in the string is equal to the harmonic mean of the weights of the two masses divided by two.\n\nReason R: The formula for tension is $T = \\frac{2 m_1 m_2}{m_1 + m_2} g$, which is precisely the harmonic mean of $m_1 g$ and $m_2 g$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: If a light string passing over a frictionless fixed pulley has a mass $m$ on one side and a man of mass $m$ on the other side, if the man climbs up the rope, the block $m$ moves upward with the same acceleration.\n\nReason R: The tension created by the man pulling the rope acts equally on the block and the man, causing identical equations of motion.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In a system of two pulleys where one is fixed and one is movable, a mechanical advantage of 2 is achieved in lifting a load.\n\nReason R: The tension in each of the two vertical segments supporting the movable pulley is half of the load being lifted in static equilibrium.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: A light string wrapped around a solid cylinder of mass $M$ and radius $R$ is pulled upward such that the cylinder does not fall or rise. The acceleration of the string is $2g$.\n\nReason R: For the center of mass to remain stationary, tension must equal $M g$, which produces an angular acceleration $\\alpha = \\tau / I = (M g R) / (\\frac{1}{2} M R^2) = 2g/R$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: When two blocks of masses $m_1$ and $m_2$ connected by a light spring are placed on a smooth table and pulled apart and released, their accelerations are in the inverse ratio of their masses.\n\nReason R: The restoring spring force exerts equal and opposite forces on both masses at every instant.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In a smooth inclined plane of angle $\\theta$ with a hanging mass $M$ connected to a mass $m$ on the incline, the system is in equilibrium if $M = m \\sin\\theta$.\n\nReason R: The component of gravity acting down the incline on mass $m$ is $m g \\sin\\theta$, which must be balanced by the tension $T = M g$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: If the pulley in an Atwood machine has a non-negligible moment of inertia $I$, the tensions in the string on the two sides of the pulley are not equal.\n\nReason R: A net torque $(T_1 - T_2) R = I \\alpha$ is required to give angular acceleration $\\alpha$ to the rotating pulley.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: Two masses $m_1$ and $m_2$ connected by an inextensible string over a frictionless pulley have equal accelerations in magnitude even if one moves horizontally and the other vertically.\n\nReason R: The inextensibility of the string ensures that the displacement of one mass along the string is strictly equal to the displacement of the other mass.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: If an Atwood machine is placed inside a freely falling elevator, the tension in the connecting string becomes zero.\n\nReason R: In a freely falling frame, the effective acceleration due to gravity is $g_{\\text{eff}} = g - g = 0$.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion A and the other is labelled as Reason R.\n\nAssertion A: In connected motion, internal forces between interacting bodies do not affect the acceleration of the center of mass of the system.\n\nReason R: According to Newton's third law, internal forces always occur in equal and opposite action-reaction pairs, so their vector sum is identically zero.\n\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both A and R are true and R is the correct explanation of A",
      "Both A and R are true but R is NOT the correct explanation of A",
      "A is true but R is false",
