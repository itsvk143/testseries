...
async function audit() {
  ...
  try {
    ...
    const docs = await col.find({ chapter: "d and f- Block Elements" }).toArray();
    console.log(`Total questions in "d and f- Block Elements": ${docs.length}`);
    ...
    console.log("\n==============================================");
    console.log(`AUDIT RESULTS FOR "d and f- Block Elements":`);
    console.log(`- Total Questions: ${docs.length} (Expected: 850)`);
    console.log(`- Genuine Preserved: ${genuineCount} (Expected: 124)`);
    console.log(`- Replaced Authenticated: ${replacedCount} (Expected: 726)`);
    ...
    if (
      ...
      console.log("\nALL 850 QUESTIONS IN THE CHAPTER ARE 100% AUDITED AND VERIFIED!");
    } else {
      process.exit(1);
    }
  } finally {
