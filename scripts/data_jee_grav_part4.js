// Auto-generated Part 4 for Gravitation - Escape velocity
module.exports = [
  {
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** If a body is projected from the surface of Earth with a speed $v > v_e$, its speed in interstellar space (at infinity) is $v_\\infty = \\sqrt{v^2 - v_e^2}$.\n\n**Reason:** By conservation of mechanical energy, $\\frac{1}{2}mv^2 - \\frac{GMm}{R} = \\frac{1}{2}mv_\\infty^2 + 0$, and $\\frac{GMm}{R} = \\frac{1}{2}mv_e^2$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** Escape velocity from the surface of a planet is directly proportional to the radius of the planet if the planet's density is uniform.\n\n**Reason:** Escape velocity can be written as $v_e = R\\sqrt{\\frac{8\\pi G\\rho}{3}}$, where $\\rho$ is the mean density.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** The escape velocity from a point at height $h = R$ above the Earth's surface is $\\frac{v_e}{\\sqrt{2}}$.\n\n**Reason:** The escape velocity at distance $r$ from Earth's centre is $v_e(r) = \\sqrt{\\frac{2GM}{r}}$, and at height $h = R$, $r = 2R$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** A rocket fired with speed equal to the escape velocity enters a parabolic trajectory relative to the Earth.\n\n**Reason:** For an orbit with total mechanical energy $E = 0$, the eccentricity of the conic section is $e = 1$, which represents a parabola.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** The escape velocity of a body from the Earth is $\\sqrt{2}$ times the orbital velocity of a satellite revolving near the Earth's surface.\n\n**Reason:** Orbital velocity near the surface is $v_o = \\sqrt{gR}$, while escape velocity is $v_e = \\sqrt{2gR}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** If the radius of the Earth contracts to half its present value while its mass remains constant, the escape velocity will increase by a factor of $\\sqrt{2}$.\n\n**Reason:** Escape velocity is inversely proportional to the square root of the radius of the planet, $v_e \\propto \\frac{1}{\\sqrt{R}}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** A body thrown horizontally with the escape velocity from a very high tower escapes the Earth's gravitational field.\n\n**Reason:** Escape speed is independent of the direction of projection, provided the body does not strike the Earth's surface.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** The escape velocity from Jupiter is much larger than that from Earth.\n\n**Reason:** Jupiter has a much greater mass than Earth, and $v_e = \\sqrt{\\frac{2GM}{R}}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** A particle projected vertically with speed $v = \\frac{v_e}{2}$ reaches a maximum height $h = \\frac{R}{3}$.\n\n**Reason:** The maximum height is given by $h = \\frac{R v^2}{v_e^2 - v^2}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** A satellite in a circular orbit around Earth requires an additional speed of $(\\sqrt{2} - 1)v_o \\approx 0.414 v_o$ to escape to infinity.\n\n**Reason:** Escape speed from any orbital radius $r$ is $v_e = \\sqrt{2} v_o$, so the speed boost needed is $\\Delta v = v_e - v_o = (\\sqrt{2} - 1)v_o$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** To escape the solar system from Earth's orbit, a body needs a higher speed than to simply escape the Earth's surface.\n\n**Reason:** The body must overcome both the gravitational potential of the Earth and the gravitational potential of the Sun.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** Escape velocity from the surface of Earth does not depend on whether the body is launched towards the East or towards the West.\n\n**Reason:** Earth's rotation from West to East provides an initial tangential velocity boost to a rocket launched towards the East.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** The kinetic energy required to project a body of mass $m$ to escape from Earth's surface is equal to $mgR$.\n\n**Reason:** Escape velocity is $v_e = \\sqrt{2gR}$, so kinetic energy is $K = \\frac{1}{2}m v_e^2 = \\frac{1}{2}m(2gR) = mgR$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** If a body is projected with speed $v = 2 v_e$, its speed at infinity is $\\sqrt{3} v_e$.\n\n**Reason:** Interstellar speed is given by $v_\\infty = \\sqrt{v^2 - v_e^2} = \\sqrt{(2v_e)^2 - v_e^2} = \\sqrt{3} v_e$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** If the mass of the Earth increases by $4\\%$ while its radius remains unchanged, the escape velocity increases by approximately $2\\%$.\n\n**Reason:** Escape velocity satisfies $v_e \\propto \\sqrt{M}$, so for small changes, $\\frac{\\Delta v_e}{v_e} = \\frac{1}{2}\\frac{\\Delta M}{M}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** If a planet has twice the mass and twice the radius of Earth, the escape velocity on that planet is equal to that on Earth.\n\n**Reason:** Escape velocity depends on the ratio $\\frac{M}{R}$, which remains unchanged when both $M$ and $R$ are doubled.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Escape velocity",
    "question": "**Assertion:** The escape velocity of a body depends on the direction of projection relative to the Earth's surface in an ideal non-rotating Earth model.\n\n**Reason:** Work done by gravity depends on the trajectory taken by the projectile.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
