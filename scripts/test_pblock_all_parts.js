...
const part1 = require('./data_pblock_part1');
const part2 = require('./data_pblock_part2');
const part3 = require('./data_pblock_part3');
const part4 = require('./data_pblock_part4');
const part5 = require('./data_pblock_part5');

const parts = [
  { name: 'Part 1: Group 13 to Group 18 electronic configuration', data: part1 },
  { name: 'Part 2: Trends in physical and chemical properties', data: part2 },
  { name: 'Part 3: Inert pair effect and allotropy', data: part3 },
  { name: 'Part 4: Oxoacids of phosphorus, sulfur, and halogens', data: part4 },
  { name: 'Part 5: Interhalogen compounds and noble gas compounds', data: part5 },
];
...
parts.forEach((p, pIdx) => {
  ...
  if (arCount !== 26 || mcqCount !== 78 || numCount !== 13) {
...
console.log(`\n========================================`);
console.log(`Total questions across 5 parts: ${totalQuestions} (Expected: 585)`);
console.log(`Total validation errors: ${errors}`);
console.log(`========================================\n`);

if (errors > 0 || totalQuestions !== 585) {
  process.exit(1);
} else {
  console.log("ALL 5 PARTS VERIFIED PERFECTLY (100% PASS)!");
}
