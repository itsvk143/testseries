...
function getDipoleMomentAndHydrogenBondingQuestions() {
  ...
  add(
    "Which of the following liquids possesses an exceptionally high dielectric constant (~78.5 at 25 ^\\circ\\text{C}) due to its polarity and hydrogen bonding?",
    ["\\text{H}_2\\text{O}", "\\text{CH}_3\\text{OH}", "\\text{CH}_3\\text{COCH}_3", "\\text{CCl}_4"],
    0,
    "The polar O-H bonds and continuous hydrogen bonding network confer an exceptionally high dielectric constant to water, drastically reducing electrostatic attractions between dissolved ions."
  );
  add(
    "Which of the following isomeric pairs can be effectively separated by steam distillation based on difference in hydrogen bonding?",
    ["ortho-nitrophenol and para-nitrophenol", "ortho-xylene and para-xylene", "cis-but-2-ene and trans-but-2-ene", "methane and ethane"],
    0,
    "ortho-nitrophenol has intramolecular H-bonding (chelation) and is steam-volatile, whereas para-nitrophenol has intermolecular H-bonding (high boiling point) and is not steam-volatile."
  );
