// Auto-generated Part 6 for Gravitation - Orbital velocity and satellite motion
module.exports = [
  {
    "type": "ASSERTION_REASON",
    "subject": "Physics",
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** An astronaut inside an artificial satellite orbiting the Earth experiences weightlessness.\n\n**Reason:** Both the astronaut and the satellite have the same orbital acceleration equal to the local acceleration due to gravity, so the normal contact force between them is zero.",
    "options": [
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** The orbital speed of a satellite revolving close to the surface of the Earth is approximately $7.92\\text{ km/s}$.\n\n**Reason:** Near the surface, the orbital speed is given by $v_o = \\sqrt{gR}$, where $g = 9.8\\text{ m/s}^2$ and $R = 6.4 \\times 10^6\\text{ m}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** For an orbiting satellite, its kinetic energy is equal to the magnitude of its total mechanical energy.\n\n**Reason:** In a circular gravitational orbit, $K = \\frac{GMm}{2r}$ and $E = -\\frac{GMm}{2r}$, so $K = |E|$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** To transfer a satellite from a lower circular orbit of radius $r_1$ to a higher circular orbit of radius $r_2$, energy must be supplied to the satellite.\n\n**Reason:** The total mechanical energy in a circular orbit is $E = -\\frac{GMm}{2r}$, which increases (becomes less negative) as the orbital radius increases.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** A small body detached from a satellite orbiting the Earth continues to orbit the Earth in the same orbit alongside the satellite.\n\n**Reason:** At the moment of detachment, the body possesses the exact same position and orbital velocity as the satellite.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** A satellite orbiting very close to the Earth's surface completes one revolution in about 84.6 minutes.\n\n**Reason:** The time period for a surface orbit is $T = 2\\pi\\sqrt{\\frac{R}{g}}$, where $R = 6400\\text{ km}$ and $g = 9.8\\text{ m/s}^2$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** The potential energy of a satellite is always twice its total mechanical energy in a circular orbit.\n\n**Reason:** In a circular orbit, $U = -\\frac{GMm}{r}$ and $E = -\\frac{GMm}{2r}$, so $U = 2E$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** A satellite in a circular orbit of radius $r$ has an acceleration equal to $\\frac{GM}{r^2}$ directed towards the centre.\n\n**Reason:** Centripetal acceleration is $a_c = \\frac{v_o^2}{r}$, and $v_o = \\sqrt{\\frac{GM}{r}}$, giving $a_c = \\frac{GM/r}{r} = \\frac{GM}{r^2}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Orbital velocity and satellite motion",
    "question": "**Assertion:** If the kinetic energy of an orbiting satellite is doubled, it will escape from the Earth's gravitational field.\n\n**Reason:** Escape requires kinetic energy $K_e = \\frac{GMm}{r}$, which is exactly twice the orbital kinetic energy $K_o = \\frac{GMm}{2r}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
