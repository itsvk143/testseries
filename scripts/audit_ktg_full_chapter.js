...
async function runAudit() {
  ...
  console.log("==================================================");
  console.log("    KINETIC THEORY OF GASES - FULL AUDIT          ");
  console.log("==================================================\n");
  ...
  const bogusRegex = /lorem ipsum|synthetic|placeholder|test question|sample question|as per pattern|field vector \$\\vec\{F\}\$ in/i;
  ...
  const testIds = [
    "jee-mains-CHAPTER-Physics-Kinetic-Theory-of-Gases-11",
    "jee-mains-SUBTOPIC-Physics-Equation-of-state",
    "jee-mains-SUBTOPIC-Physics-kinetic-interpretation-of-temperature",
    "jee-mains-SUBTOPIC-Physics-degrees-of-freedom",
    "neet-CHAPTER-Physics-Kinetic-Theory-of-Gases-11",
    "neet-SUBTOPIC-Physics-Equation-of-state",
    "neet-SUBTOPIC-Physics-kinetic-interpretation-of-temperature",
    "neet-SUBTOPIC-Physics-degrees-of-freedom"
  ];
  ...
  for (const tid of testIds) {
    ...
    const nonChapterDocs = resolvedDocs.filter(d => d.chapter !== "Kinetic Theory of Gases");
    ...
    console.log(`  Chapter purity: ${resolvedDocs.length - nonChapterDocs.length}/${resolvedDocs.length} in "Kinetic Theory of Gases"`);
