// Auto-generated Part 3 for Gravitation - Kepler's laws
module.exports = [
  {
    ...
    "question": "**Assertion:** Kepler's second law (law of areas) is a direct consequence of the conservation of angular momentum.\n\n**Reason:** The gravitational force exerted by the Sun on a planet is a central force, exerting zero torque about the Sun.",
    "options": [
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** A planet moves fastest in its orbit when it is closest to the Sun (at perihelion) and slowest when it is farthest (at aphelion).\n\n**Reason:** By conservation of angular momentum, $r_p v_p = r_a v_a$, so orbital speed is inversely proportional to distance from the Sun.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** If the distance between the Earth and the Sun is doubled, the length of the year would become $2\\sqrt{2}$ times its present value.\n\n**Reason:** By Kepler's third law, $T \\propto a^{3/2}$, so $(2)^{3/2} = 2\\sqrt{2} \\approx 2.83$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** The linear momentum of a planet revolving around the Sun in an elliptical orbit is not conserved.\n\n**Reason:** The planet is subjected to an external gravitational force from the Sun, so net force $\\vec{F} \\ne 0$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** The semi-major axis $a$ of an elliptical orbit is equal to the arithmetic mean of the perihelion distance and aphelion distance.\n\n**Reason:** Perihelion distance is $r_p = a(1 - e)$ and aphelion distance is $r_a = a(1 + e)$, so $\\frac{r_p + r_a}{2} = a$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** In a binary star system where two stars of masses $M_1$ and $M_2$ rotate about their common centre of mass, both stars have the same orbital period.\n\n**Reason:** Both stars always remain diametrically opposite to each other with respect to the centre of mass to keep the centre of mass at rest.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** If a satellite in a circular orbit has its orbital radius reduced by atmospheric drag, its orbital speed actually increases.\n\n**Reason:** For a circular orbit, orbital speed $v = \\sqrt{\\frac{GM}{r}}$, so a decrease in $r$ results in an increase in $v$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** The total mechanical energy of a planet of mass $m$ in an elliptical orbit of semi-major axis $a$ around the Sun is $E = -\\frac{GMm}{2a}$.\n\n**Reason:** The semi-major axis $a$ of an ellipse plays the identical energetic role as the radius $r$ of a circular orbit.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** A planet takes less time to traverse the half of its elliptical orbit containing perihelion than the half containing aphelion.\n\n**Reason:** By Kepler's second law, equal areas are swept in equal times, and the perihelion side has shorter radius vectors requiring faster traversal.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** If the mass of the Sun suddenly became four times its present value, the orbital period of the Earth would be halved, assuming the orbital radius remained unchanged.\n\n**Reason:** From Kepler's third law, $T = 2\\pi \\sqrt{\\frac{r^3}{GM}}$, so $T \\propto \\frac{1}{\\sqrt{M}}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** The velocity of a planet at perihelion $v_p$ and aphelion $v_a$ satisfy $\\frac{v_p}{v_a} = \\frac{1 + e}{1 - e}$.\n\n**Reason:** Conservation of angular momentum requires $v_p r_p = v_a r_a$, and $r_p = a(1 - e)$ while $r_a = a(1 + e)$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** A satellite in a higher circular orbit has a longer time period and a smaller orbital speed than one in a lower orbit.\n\n**Reason:** Orbital speed is $v = \\sqrt{\\frac{GM}{r}}$ and time period is $T = 2\\pi \\sqrt{\\frac{r^3}{GM}}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** The ratio of maximum to minimum angular velocity of a planet in an elliptical orbit is $\\left(\\frac{1+e}{1-e}\\right)^2$.\n\n**Reason:** Angular momentum is $L = m r^2 \\omega = \\text{constant}$, so $\\omega \\propto \\frac{1}{r^2}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** If a satellite's speed is increased at perigee by a small amount, its apogee distance increases.\n\n**Reason:** Increasing kinetic energy at perigee increases the semi-major axis $a$ of the orbit, since $E = -\\frac{GMm}{2a}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Gravitation",
    "subTopic": "Kepler's laws",
    "question": "**Assertion:** The period of revolution of a planet does not depend on the mass of the planet, provided its mass is negligible compared to the star.\n\n**Reason:** The gravitational force provides the centripetal acceleration, and the mass of the planet cancels out from the equation of motion.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
