...
const subtopics = [
  { name: "Nature of C–X bond", data: require("./data_halogens_part1.js") },
  { name: "Nomenclature", data: require("./data_halogens_part2.js") },
  { name: "Haloalkanes", data: require("./data_halogens_part3.js") },
  { name: "Haloarenes", data: require("./data_halogens_part4.js") },
  { name: "Mechanism of substitution", data: require("./data_halogens_part5.js") },
  { name: "SN1 and SN2 reaction mechanisms and stereochemistry", data: require("./data_halogens_part6.js") },
  { name: "Elimination reactions (Saytzeff's rule)", data: require("./data_halogens_part7.js") },
  { name: "Polyhalogen compounds (chloroform, iodoform, DDT, Freons)", data: require("./data_halogens_part8.js") }
];
