...
// ==========================================
// SUBTOPIC 4: Nernst equation (26 AR, 7 MCQ, 15 NUM = 48)
// ==========================================
...
// ==========================================
// SUBTOPIC 5: Faraday's laws of electrolysis (26 AR, 7 MCQ, 15 NUM = 48)
// ==========================================
...
// ==========================================
// SUBTOPIC 6: Batteries, fuel cells, and corrosion (25 AR, 8 MCQ, 15 NUM = 48)
// ==========================================
...
const nernst = getNernstEquationQuestions();
const faraday = getFaradayLawsQuestions();
const bat = getBatteriesCorrosionQuestions();

console.log(`Nernst equation: ${nernst.length} questions`);
console.log(`Faraday's laws: ${faraday.length} questions`);
console.log(`Batteries, fuel cells, and corrosion: ${bat.length} questions`);

[...nernst, ...faraday, ...bat].forEach((q, idx) => {
  checkKatex(q.question, `Part2[${idx}].question`);
  q.options.forEach((o, oidx) => checkKatex(o, `Part2[${idx}].options[${oidx}]`));
  checkKatex(q.explanation, `Part2[${idx}].explanation`);
});
console.log("All Part 2 questions validated KaTeX successfully (0 errors)!");

// Write to scripts/data_redox_part2.js
const fileContent = `// Part 2: Authentic Questions for Redox Reactions and Electrochemistry
// Subtopics: Nernst equation (48), Faraday's laws of electrolysis (48), Batteries, fuel cells, and corrosion (48)

${getNernstEquationQuestions.toString()}
${getFaradayLawsQuestions.toString()}
${getBatteriesCorrosionQuestions.toString()}
${createMCQ.toString()}
${createAR.toString()}
...
fs.writeFileSync(__dirname + "/data_redox_part2.js", fileContent);
console.log("Written scripts/data_redox_part2.js successfully!");
