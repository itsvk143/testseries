// scripts/audit_sequences_mathematics.js
// Exhaustive post-replacement audit for Sequences & Series (Mathematics, Class 12)
...
async function main() {
  ...
  console.log(`Total questions found: ${questions.length} (Expected: 202)`);
  ...
  for (const q of questions) {
    ...
    for (const kw of BOGUS_KEYWORDS) {
      if (fullText.includes(kw)) {
        console.error(`❌ ${qLabel} contains bogus keyword "${kw}"`);
        errors++;
      }
    }
  ...
  console.log(`\n=== 2. TEST PAPERS AUDIT ===`);
  const testPaperIds = [
    { id: '6a9e2843c527cd38431011b0', name: 'Chapter: Sequences & Series' },
    { id: '6a9e2887c527cd3843101332', name: 'Subtopic: Arithmetic Progression' },
    { id: '6a9e2888c527cd3843101333', name: 'Subtopic: Geometric Progression' },
    { id: '6a9e2888c527cd3843101334', name: 'Subtopic: Insertion of AM and GM' }
  ];
  ...
  for (const tp of testPaperIds) {
    ...
    for (const qId of paper.questions) {
      ...
      if (doc.chapter !== 'Sequences & Series') {
