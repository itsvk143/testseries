// Auto-generated Part 3 for Physics and Measurement - Error analysis
module.exports = [
  {
    ...
    "question": "**Assertion:** Systematic errors cannot be eliminated completely from an experiment, but they can be minimized by improving experimental techniques.\n\n**Reason:** Systematic errors tend to be in one direction, either positive or negative, due to known causes like zero error or calibration defect.",
    "options": [
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** If $Z = A - B$, the absolute error in $Z$ is equal to the sum of absolute errors in $A$ and $B$, i.e., $\\Delta Z = \\Delta A + \\Delta B$.\n\n**Reason:** In subtraction of two quantities, the absolute errors always add up to find the maximum possible error.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** In a quotient $Z = \\frac{A}{B}$, the relative error $\\frac{\\Delta Z}{Z} = \\frac{\\Delta A}{A} + \\frac{\\Delta B}{B}$.\n\n**Reason:** When two physical quantities are divided, the relative errors multiply together.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** In the formula $X = \\frac{A^2 B^3}{C^4}$, the quantity $C$ contributes the maximum fractional error if the percentage error in all three variables is the same.\n\n**Reason:** The fractional error contribution of a quantity in a power formula is directly proportional to the power/exponent to which it is raised.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** The percentage error in measuring the kinetic energy of a particle moving with velocity $v$ is twice the percentage error in velocity, assuming mass is constant.\n\n**Reason:** Kinetic energy is given by $K = \\frac{1}{2}mv^2$, and power exponents multiply relative errors.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** If a quantity is calculated from $Y = \\frac{MgL}{\\pi r^2 l}$, the radius $r$ must be measured with the highest precision.\n\n**Reason:** In the expression for Young's modulus, the radius $r$ appears in the denominator raised to the power of 2.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** The fractional error in determination of acceleration due to gravity $g$ using a simple pendulum is given by $\\frac{\\Delta g}{g} = \\frac{\\Delta L}{L} + 2\\frac{\\Delta T}{T}$.\n\n**Reason:** The time period of a simple pendulum is $T = 2\\pi \\sqrt{\\frac{L}{g}}$, which gives $g = \\frac{4\\pi^2 L}{T^2}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** To minimize percentage error in measuring the time period $T$ of a simple pendulum, one should measure the time for a large number of oscillations $n$ rather than a single oscillation.\n\n**Reason:** Measuring the time $t$ for $n$ oscillations reduces the absolute error in each oscillation's period to $\\frac{\\Delta t}{n}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** Absolute error always has the same unit and dimensions as the physical quantity being measured.\n\n**Reason:** Relative error is dimensionless and has no unit.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** If two resistors $R_1 = (100 \\pm 3)\\,\\Omega$ and $R_2 = (200 \\pm 4)\\,\\Omega$ are connected in series, the equivalent resistance is $(300 \\pm 7)\\,\\Omega$.\n\n**Reason:** In series combination, the absolute errors in individual resistances add up.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** For two resistors connected in parallel, the relative error in equivalent resistance is always equal to the sum of relative errors of the individual resistors.\n\n**Reason:** For parallel combination, $\\frac{1}{R_p} = \\frac{1}{R_1} + \\frac{1}{R_2}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** In a spherical body, if the percentage error in radius measurement is $1\\%$, the percentage error in volume is $3\\%$.\n\n**Reason:** The volume of a sphere is $V = \\frac{4}{3}\\pi r^3$, so $\\frac{\\Delta V}{V} = 3\\frac{\\Delta r}{r}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** The percentage error in density of a cube is equal to the percentage error in mass plus three times the percentage error in its edge length.\n\n**Reason:** Density $\\rho = \\frac{m}{L^3}$, and for maximum error, errors in numerator and denominator add up.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** Least count error is the error associated with the resolution of the measuring instrument.\n\n**Reason:** Least count error can be categorized under both systematic and random errors.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** Gross errors are caused by sheer carelessness of the observer in taking readings or recording data.\n\n**Reason:** Gross errors follow normal Gaussian distribution and can be treated statistically.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** In measuring focal length of a concave mirror using the $u-v$ method, the error in $f$ satisfies $\\frac{\\Delta f}{f^2} = \\frac{\\Delta u}{u^2} + \\frac{\\Delta v}{v^2}$.\n\n**Reason:** From the mirror formula $\\frac{1}{f} = \\frac{1}{v} + \\frac{1}{u}$, differentiating both sides gives $-\\frac{df}{f^2} = -\\frac{dv}{v^2} - \\frac{du}{u^2}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** If percentage error in measuring the radius of a wire is $2\\%$, the percentage error in its cross-sectional area is $4\\%$.\n\n**Reason:** The cross-sectional area of a wire is $A = \\pi r^2$, giving fractional error $\\frac{\\Delta A}{A} = 2\\frac{\\Delta r}{r}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** Environmental errors are caused by external conditions such as changes in temperature, pressure, and humidity.\n\n**Reason:** Environmental errors are always completely unpredictable and cannot be corrected.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** When multiplying two numbers, the relative error in the product equals the sum of relative errors in the individual numbers.\n\n**Reason:** For $Z = AB$, $\\ln Z = \\ln A + \\ln B$, so differentiating gives $\\frac{\\Delta Z}{Z} = \\frac{\\Delta A}{A} + \\frac{\\Delta B}{B}$.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
  ...
  },
  {
    ...
    "chapter": "Physics and Measurement",
    "subTopic": "Error analysis",
    "question": "**Assertion:** If $P = \\frac{A^3 B^{1/2}}{C D^{3/2}}$, the percentage error in $P$ is $3\\left(\\frac{\\Delta A}{A}\\right) + \\frac{1}{2}\\left(\\frac{\\Delta B}{B}\\right) + \\frac{\\Delta C}{C} + \\frac{3}{2}\\left(\\frac{\\Delta D}{D}\\right)$ multiplied by 100.\n\n**Reason:** Powers in the denominator contribute with negative signs to the maximum possible relative error.",
    "options": [
      "Both Assertion and Reason are true and Reason is the correct explanation of Assertion",
      "Both Assertion and Reason are true but Reason is NOT the correct explanation of Assertion",
      "Assertion is true but Reason is false",
