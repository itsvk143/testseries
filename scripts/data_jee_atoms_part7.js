module.exports = [
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Thermal (slow) neutrons are much more effective at inducing fission in $^{235}\\text{U}$ than fast neutrons.\\nReason (R): Slow neutrons have a longer de Broglie wavelength and spend more time in the vicinity of the target nucleus, vastly increasing the capture cross-section.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
    ...
    "subtopic": "Nuclear fission and fusion",
    "subTopic": "Nuclear fission and fusion",
    "class": "Class 12",
    "difficulty": "Hard",
    "examType": "JEE Mains",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Heavy water ($D_2O$) and graphite are widely used as moderators in nuclear fission reactors.\\nReason (R): Good moderators must have light nuclei that extract substantial kinetic energy per collision without absorbing the neutrons.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Cadmium and boron rods are used as control rods in a nuclear reactor.\\nReason (R): Cadmium and boron have exceptionally large cross-sections for absorbing thermal neutrons.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): To sustain a controlled nuclear chain reaction in a power reactor, the neutron multiplication factor $k$ must be maintained at exactly $1$.\\nReason (R): If $k > 1$, the chain reaction grows exponentially, causing power surges or meltdown, while if $k < 1$, the reaction gradually dies out.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Delayed neutrons play a vital role in the safe control of nuclear reactors.\\nReason (R): Delayed neutrons are emitted seconds to minutes after fission by certain fission products, providing sufficient response time for mechanical control rod mechanisms.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Thermonuclear fusion reactions require extremely high temperatures of the order of $10^7 - 10^8\\text{ K}$.\\nReason (R): Positively charged nuclei must have sufficient thermal kinetic energy to overcome the repulsive electrostatic Coulomb barrier between them.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The energy liberated per nucleon in nuclear fusion is greater than that in nuclear fission.\\nReason (R): The rise in the binding energy per nucleon curve from light nuclei ($A \\le 4$) to helium ($^4\\text{He}$) is much steeper than from uranium to intermediate-mass nuclei.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A hydrogen bomb operates on the principle of uncontrolled thermonuclear fusion.\\nReason (R): A fission bomb (atomic bomb) is detonated first to create the extreme temperature and pressure necessary to initiate fusion in the hydrogen bomb core.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Ordinary water ($H_2O$) is a less efficient moderator than heavy water ($D_2O$) when using natural uranium fuel.\\nReason (R): Ordinary hydrogen ($^1_1\\text{H}$) has a much higher capture cross-section for thermal neutrons via $p + n \\to ^2\\text{H} + \\gamma$ than deuterium.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Natural uranium cannot sustain a chain reaction in an unmoderated block.\\nReason (R): Most of the natural uranium is $^{238}\\text{U}$ ($99.3\\%$), which captures fast fission neutrons through resonance absorption without undergoing fission.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The main source of energy radiated by the Sun and other stars is thermonuclear fusion of hydrogen into helium.\\nReason (R): In the solar core, four protons fuse through the proton-proton chain cycle into a helium nucleus, two positrons, two neutrinos, and gamma photons, releasing $\\approx 26.7\\text{ MeV}$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Nuclear fusion is inherently safer than nuclear fission regarding runaway accidents.\\nReason (R): Thermonuclear fusion requires precise plasma temperature and density conditions; any disruption or vessel breach causes immediate plasma cooling and terminates the reaction instantly.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The Lawson criterion defines the condition necessary for achieving net energy gain in controlled thermonuclear fusion.\\nReason (R): The Lawson criterion requires that the product of plasma density $n$ and confinement time $\\tau$ exceed a threshold value determined by the operating temperature: $n\\tau \\ge f(T)$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Tokamak devices use strong magnetic fields to confine high-temperature plasma in a toroidal (doughnut-shaped) chamber.\\nReason (R): Charged particles in a magnetic field experience a Lorentz force that forces them into helical trajectories along magnetic field lines, preventing them from touching the physical chamber walls.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): In a nuclear fission event, the majority of the released energy ($approx 85\\%$) appears as kinetic energy of the fission fragments.\\nReason (R): The electrostatic Coulomb repulsion pushes the two massive positively charged daughter fragments apart with tremendous mutual kinetic energy.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Fertile isotopes such as $^{238}\\text{U}$ and $^{232}\\text{Th}$ can be converted into fissile isotopes inside breeder reactors.\\nReason (R): Neutron capture by $^{238}\\text{U}$ followed by two successive $\\beta^-$-decays produces fissile plutonium-239 ($^{239}\\text{Pu}$).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Neutrinos emitted during nuclear fusion in the Sun escape almost instantaneously into space without heating the solar plasma.\\nReason (R): Neutrinos interact with matter only via the extremely weak force and have practically zero cross-section for interaction with the solar interior.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The D-T fusion reaction ($^2_1\\text{H} + ^3_1\\text{H} \\to ^4_2\\text{He} + ^1_0n$) is currently favored for terrestrial fusion reactors over the D-D reaction.\\nReason (R): The D-T reaction has a significantly higher fusion cross-section and ignites at a lower temperature ($~10^8\\text{ K}$) than D-D fusion.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Fission fragments are almost always radioactive and decay via $\\beta^-$-emission.\\nReason (R): Fission fragments retain the high neutron-to-proton ratio ($N/Z \\sim 1.5$) of the parent heavy nucleus, leaving them neutron-rich compared to stable intermediate nuclei ($N/Z \\sim 1.2-1.3$).\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Breeder reactors produce more fissile material than they consume.\\nReason (R): Each fission in a fast breeder reactor releases on average about $2.9$ neutrons, allowing one neutron to sustain the chain reaction and more than one neutron to convert fertile nuclei into fissile fuel.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): The mass defect per fission of $^{235}\\text{U}$ is approximately $0.215\\text{ u}$.\\nReason (R): Energy released per fission is $Q \\approx 200\\text{ MeV}$, and $\\Delta m = \\frac{200\\text{ MeV}}{931.5\\text{ MeV/u}} \\approx 0.215\\text{ u}$.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Inertial confinement fusion utilizes intense laser beams to compress a tiny pellet of deuterium-tritium fuel.\\nReason (R): Rapid surface ablation of the fuel capsule creates an inward rocket-like reaction force that implodes the core to extreme densities and thermonuclear temperatures.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Heavy nuclei do not undergo spontaneous fusion under ordinary conditions.\\nReason (R): The electrostatic Coulomb repulsion between large positive charges ($Z_1 Z_2 e^2$) creates an enormous barrier that completely prevents nuclei from coming within nuclear force range.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): A nuclear reactor cannot explode like an atomic bomb.\\nReason (R): Power reactor fuel is enriched to only about $3-5\\% ^{235}\\text{U}$ (compared to $>90\\%$ in weapons), and the geometric layout prevents the prompt supercritical assembly required for a nuclear detonation.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Liquid sodium is often used as a coolant in fast breeder reactors.\\nReason (R): Liquid sodium has excellent thermal conductivity and a low neutron moderation capability, preventing the slowing down of fast neutrons essential for breeding.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  {
    "question": "Given below are two statements: one is labelled as Assertion (A) and the other is labelled as Reason (R).\\nAssertion (A): Nuclear fusion reactions are called thermonuclear reactions.\\nReason (R): The kinetic energy required for the fusing nuclei to overcome electrostatic repulsion is provided by the thermal energy of the system at extremely high temperatures.\\nIn the light of the above statements, choose the correct answer from the options given below:",
    "options": [
      "Both (A) and (R) are true and (R) is the correct explanation of (A)",
      "Both (A) and (R) are true but (R) is not the correct explanation of (A)",
      "(A) is true but (R) is false",
  ...
  },
  {
    ...
    "explanation": "$\\Delta m = \\frac{3.2\\times 10^{-11}}{9\\times 10^{16}} = 3.56\\times 10^{-28}\\text{ kg} \\approx 4\\times 10^{-28}\\text{ kg} \\implies x = 4$.",
    "type": "NUMERICAL",
  ...
  },
  {
    ...
    "explanation": "Approximately $83.5\\%$ of the fission energy appears as kinetic energy of the fragments: $0.835 \\times 200 = 167\\text{ MeV}$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$K_\\alpha = \\frac{1}{5} \\times 17.6 = 3.52\\text{ MeV} \\approx 4\\text{ MeV}$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$\\frac{dN}{dt} = \\frac{10^9\\text{ J/s}}{3.2\\times 10^{-11}\\text{ J}} = 3.125\\times 10^{19}\\text{ s}^{-1} \\implies x = 3$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$\\Delta k = 1.002 - 1 = 0.002 = 2\\times 10^{-3} \\implies x = 2$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "Mass number conservation: $235 + 1 = 140 + 94 + x \\implies 236 = 234 + x \\implies x = 2$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$E = \\frac{26.7}{4} = 6.675\\text{ MeV} \\approx 7\\text{ MeV}$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$P = \\frac{1.64\\times 10^{14}\\text{ J}}{2.592\\times 10^6\\text{ s}} = 6.327\\times 10^7\\text{ W} \\approx 63\\text{ MW}$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "Conservation of atomic number: $92 + 0 = 38 + Z_Y + 0 \\implies Z_Y = 92 - 38 = 54$ (Xenon, $\\text{Xe}$).",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "Conservation of mass number: $235 + 1 = 95 + A_Y + 3 \\implies 236 = 98 + A_Y \\implies A_Y = 138$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$E / A = \\frac{3.27}{4} = 0.8175\\text{ MeV/nucleon} \\approx 1\\text{ MeV/nucleon}$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$E = 1.5 \\times (8.62\\times 10^{-5}\\text{ eV/K}) \\times 10^8\\text{ K} = 12930\\text{ eV} \\approx 13\\text{ keV}$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "For a critical reactor sustaining steady power, $k = 1$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$N = \\frac{1}{3.2\\times 10^{-11}} = 3.125\\times 10^{10} \\implies x = 3$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$\\text{Breeding ratio} = \\frac{120}{100} = 1.2 = \\frac{12}{10} \\implies x = 12$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "Natural uranium consists of $\\approx 99.28\\% ^{238}\\text{U}$ and $\\approx 0.72\\% ^{235}\\text{U} \\approx 1\\%$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "The heavier product is $^4_2\\text{He}$, whose mass number is $4$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$N = \\frac{2\\times 10^6}{3.2\\times 10^{-11}} = 6.25\\times 10^{16} \\implies x = 6$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$N_3 = 2.5^3 = 15.625 \\approx 16$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
  ...
  },
  {
    ...
    "explanation": "$\\Delta m = \\frac{17.6}{931.5} = 0.0189\\text{ u} \\approx 0.02\\text{ u} = 2\\times 10^{-2}\\text{ u} \\implies x = 2$.",
    "type": "NUMERICAL",
    "questionType": "NUMERICAL",
    "subject": "Physics",
    "chapter": "Atoms and Nuclei",
